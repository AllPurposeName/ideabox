  ...
  def divs
    ...
    when "Hooch"
      { 0 => "glyphicon glyphicon-thumbs-down col-md-4",
        1 => "glyphicon glyphicon-thumbs-up col-md-4",
        2 => "glyphicon glyphicon-remove-circle col-md-4 itemId" }
    else
      { 0 => "glyphicon glyphicon-thumbs-down col-md-4",
        1 => "glyphicon glyphicon-remove-circle col-md-offset-4 col-md-4 itemId" }
    end
  end
